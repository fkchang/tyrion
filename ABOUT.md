...
- 2026-07-11 | hook-hardening-2 shipped (4/4) | review: third dark-factory run — F1/F2/F4/F5 closed (quote-safe lanes, close warnings, cd-target resolution, --check armed reporting); new soft spots: first-closer commit bleed, gate-name coverage unchecked (lane-12 recorded 'rspec' not pre-push+uat) | spawned: none
